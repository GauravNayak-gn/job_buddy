...
echo ""
echo "  bash scripts/start_backends.sh"
echo ""
echo "To stop all services:"
echo ""
echo "  bash scripts/stop_backends.sh"
echo ""
echo "To test through nginx:"
echo "  curl http://localhost:80/api/auth/health/"
echo "  curl http://localhost:80/api/jobs/health/"
echo ""
